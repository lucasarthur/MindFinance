...
class FixaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.fixa_activity)
    ...
    private fun loadContas() {
        ...
        val contas = dbHelper.getAllContasFixas(currentUserId)
        var total = 0.0
    ...
    private fun showAddOrEditDialog(conta: ContaFixa?) {
        ...
        val dialogTitle = if (conta == null) "Adicionar Conta Fixa" else "Editar Conta Fixa"
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton(if (conta == null) "Adicionar" else "Salvar") { dialog, _ ->
                ...
                if (nome.isNotEmpty() && valorStr.isNotEmpty()) {
                    ...
                    if (conta == null) {
                        dbHelper.addContaFixa(novaConta)
                        Toast.makeText(this, "Conta adicionada!", Toast.LENGTH_SHORT).show()
                    } else {
                        dbHelper.updateContaFixa(novaConta)
    ...
    private fun showDeleteConfirmationDialog(conta: ContaFixa) {
        AlertDialog.Builder(this)
            .setTitle("Apagar Conta")
            .setMessage("Tem certeza que deseja apagar a conta '${conta.nome}'?")
            .setPositiveButton("Apagar") { _, _ ->
                dbHelper.deleteContaFixa(conta)
